...
class CW(Attack):
    ...
    def __init__(self, model, c=1, kappa=0, steps=50, lr=0.01, mask = None):
    ...
    def forward(self, images, labels):
        ...
        for step in range(self.steps):
            ...
            if(self.mask!=None): adv_images = self.tanh_space(w)
            else: adv_images = self.tanh_space(self.mask*w + (1-self.mask)*w0)
